...
public class SearchStrategyResolver {
	...
	static {
		SEARCH_STRATEGY_COMMAND_MAP.put(SearchStrategyCommandValidator.SEARCH_STRATEGY_COMMAND_DIJKSTRA,
				new DijkstraSearchStrategy());
		SEARCH_STRATEGY_COMMAND_MAP.put(SearchStrategyCommandValidator.SEARCH_STRATEGY_COMMAND_BREADTHFIRST,
				new BreadthFirstSearchStrategy());
		SEARCH_STRATEGY_COMMAND_MAP.put(SearchStrategyCommandValidator.SEARCH_STRATEGY_COMMAND_DEPTHFIRST,
